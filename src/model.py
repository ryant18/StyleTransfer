...
def get_feature_representations(model, content_path, style_path):
    ...
    """
    # Load our images in
    content_image = image_util.load_and_process(content_path)
    style_image = image_util.load_and_process(style_path)
...
def run_style_transfer(content_path,
    ...
    # Set initial image
    init_image = image_util.load_and_process(content_path)
